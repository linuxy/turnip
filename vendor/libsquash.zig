...
pub const __pthread_unwind_buf_t = extern struct {
    __cancel_jmp_buf: [1]struct_unnamed_15,
    __pad: [4]?*anyopaque,
};
...
pub extern var squash_global_mutex: pthread_mutex_t;
pub extern fn MUTEX_INIT(mutex: [*c]pthread_mutex_t) c_int;
pub extern fn MUTEX_LOCK(mutex: [*c]pthread_mutex_t) c_int;
pub extern fn MUTEX_UNLOCK(mutex: [*c]pthread_mutex_t) c_int;
pub extern fn MUTEX_DESTORY(mutex: [*c]pthread_mutex_t) c_int;
...
pub const sqfs_mode_t = mode_t;
pub const sqfs_id_t = uid_t;
pub const sqfs_off_t = off_t;
pub const sqfs_fd_t = [*c]const u8;
pub const SQFS_OK: c_int = 0;
pub const SQFS_ERR: c_int = 1;
pub const SQFS_BADFORMAT: c_int = 2;
pub const SQFS_BADVERSION: c_int = 3;
pub const SQFS_BADCOMP: c_int = 4;
pub const SQFS_UNSUP: c_int = 5;
pub const sqfs_err = c_uint;
pub const sqfs_inode_id = u64;
pub const sqfs_inode_num = u32;
...
pub const struct_squashfs_super_block = extern struct {
    s_magic: __le32,
    inodes: __le32,
    mkfs_time: __le32,
    block_size: __le32,
    ...
    root_inode: __le64,
    bytes_used: __le64,
    id_table_start: __le64,
    xattr_id_table_start: __le64,
    inode_table_start: __le64,
    directory_table_start: __le64,
    fragment_table_start: __le64,
    lookup_table_start: __le64,
};
pub const sqfs_decompressor = ?*const fn (?*anyopaque, usize, ?*anyopaque, [*c]usize) callconv(.C) sqfs_err;
pub const struct_sqfs = extern struct {
    fd: sqfs_fd_t,
    offset: usize,
    sb: [*c]struct_squashfs_super_block,
    id_table: sqfs_table,
    frag_table: sqfs_table,
    export_table: sqfs_table,
    md_cache: sqfs_cache,
    data_cache: sqfs_cache,
    frag_cache: sqfs_cache,
    blockidx: sqfs_cache,
    decompressor: sqfs_decompressor,
    root_alias: [*c]const u8,
    root_alias2: [*c]const u8,
};
pub const sqfs = struct_sqfs;
pub const struct_squashfs_base_inode = extern struct {
    inode_type: __le16,
    mode: __le16,
    uid: __le16,
    guid: __le16,
...
const union_unnamed_20 = extern union {
    dev: struct_unnamed_21,
    symlink_size: usize,
    reg: struct_unnamed_22,
    dir: struct_unnamed_23,
};
pub const struct_sqfs_inode = extern struct {
    base: struct_squashfs_base_inode,
    nlink: c_int,
    next: sqfs_md_cursor,
    xtra: union_unnamed_20,
};
pub const sqfs_inode = struct_sqfs_inode;
pub const sqfs_block = extern struct {
    size: usize,
    data: ?*anyopaque,
    data_need_freeing: c_short,
};
pub const sqfs_md_cursor = extern struct {
    block: sqfs_off_t,
    offset: usize,
};
pub const __s8 = i8;
...
pub const struct_squashfs_dir_index = extern struct {
    index: __le32,
    start_block: __le32,
    size: __le32,
};
pub const struct_squashfs_ipc_inode = extern struct {
    inode_type: __le16,
    mode: __le16,
    uid: __le16,
    guid: __le16,
...
pub const struct_squashfs_lipc_inode = extern struct {
    inode_type: __le16,
    mode: __le16,
    uid: __le16,
    guid: __le16,
...
pub const struct_squashfs_dev_inode = extern struct {
    inode_type: __le16,
    mode: __le16,
    uid: __le16,
    guid: __le16,
...
pub const struct_squashfs_ldev_inode = extern struct {
    inode_type: __le16,
    mode: __le16,
    uid: __le16,
    guid: __le16,
...
pub const struct_squashfs_symlink_inode = extern struct {
    inode_type: __le16,
    mode: __le16,
    uid: __le16,
    guid: __le16,
...
pub const struct_squashfs_reg_inode = extern struct {
    inode_type: __le16,
    mode: __le16,
    uid: __le16,
    guid: __le16,
...
pub const struct_squashfs_lreg_inode = extern struct {
    inode_type: __le16,
    mode: __le16,
    uid: __le16,
    guid: __le16,
...
pub const struct_squashfs_dir_inode = extern struct {
    inode_type: __le16,
    mode: __le16,
    uid: __le16,
    guid: __le16,
...
pub const struct_squashfs_ldir_inode = extern struct {
    inode_type: __le16,
    mode: __le16,
    uid: __le16,
    guid: __le16,
...
pub const struct_squashfs_dir_entry = extern struct {
    offset: __le16,
    inode_number: __le16,
    type: __le16,
    size: __le16,
};
pub const struct_squashfs_dir_header = extern struct {
    count: __le32,
    start_block: __le32,
    inode_number: __le32,
};
pub const struct_squashfs_fragment_entry = extern struct {
    start_block: __le64,
    size: __le32,
    unused: c_uint,
};
pub const struct_squashfs_xattr_entry = extern struct {
    type: __le16,
    size: __le16,
};
pub const struct_squashfs_xattr_val = extern struct {
    vsize: __le32,
};
pub const struct_squashfs_xattr_id = extern struct {
    xattr: __le64,
    count: __le32,
    size: __le32,
};
pub const struct_squashfs_xattr_id_table = extern struct {
    xattr_table_start: __le64,
    xattr_ids: __le32,
    unused: __le32,
};
pub const sqfs_dir = extern struct {
    cur: sqfs_md_cursor,
    offset: sqfs_off_t,
    total: sqfs_off_t,
    header: struct_squashfs_dir_header,
};
pub const sqfs_dir_entry = extern struct {
    inode: sqfs_inode_id,
    inode_number: sqfs_inode_num,
    type: c_int,
    name: [*c]u8,
    name_size: usize,
    offset: sqfs_off_t,
    next_offset: sqfs_off_t,
};
pub const sqfs_name = [257]u8;
pub const sqfs_path = [2049]u8;
pub extern fn sqfs_dir_open(fs: [*c]sqfs, inode: [*c]sqfs_inode, dir: [*c]sqfs_dir, offset: off_t) sqfs_err;
pub extern fn sqfs_dentry_init(entry: [*c]sqfs_dir_entry, namebuf: [*c]u8) void;
pub extern fn sqfs_dir_next(fs: [*c]sqfs, dir: [*c]sqfs_dir, entry: [*c]sqfs_dir_entry, err: [*c]sqfs_err) c_short;
pub extern fn sqfs_dir_lookup(fs: [*c]sqfs, inode: [*c]sqfs_inode, name: [*c]const u8, namelen: usize, entry: [*c]sqfs_dir_entry, found: [*c]c_short) sqfs_err;
pub extern fn sqfs_lookup_path_inner(fs: [*c]sqfs, inode: [*c]sqfs_inode, path: [*c]const u8, found: [*c]c_short, follow_link: c_short) sqfs_err;
pub extern fn sqfs_lookup_path(fs: [*c]sqfs, inode: [*c]sqfs_inode, path: [*c]const u8, found: [*c]c_short) sqfs_err;
pub extern fn sqfs_dentry_offset(entry: [*c]sqfs_dir_entry) sqfs_off_t;
pub extern fn sqfs_dentry_next_offset(entry: [*c]sqfs_dir_entry) sqfs_off_t;
pub extern fn sqfs_dentry_type(entry: [*c]sqfs_dir_entry) c_int;
pub extern fn sqfs_dentry_mode(entry: [*c]sqfs_dir_entry) sqfs_mode_t;
pub extern fn sqfs_dentry_inode(entry: [*c]sqfs_dir_entry) sqfs_inode_id;
pub extern fn sqfs_dentry_inode_num(entry: [*c]sqfs_dir_entry) sqfs_inode_num;
pub extern fn sqfs_dentry_name_size(entry: [*c]sqfs_dir_entry) usize;
pub extern fn sqfs_dentry_is_dir(entry: [*c]sqfs_dir_entry) c_short;
pub extern fn sqfs_dentry_name(entry: [*c]sqfs_dir_entry) [*c]const u8;
pub const sqfs_cache_idx = u64;
pub const sqfs_cache_dispose = ?*const fn (?*anyopaque) callconv(.C) void;
pub const sqfs_cache = extern struct {
    idxs: [*c]sqfs_cache_idx,
    buf: [*c]u8,
    dispose: sqfs_cache_dispose,
    size: usize,
    count: usize,
    next: usize,
    mutex: pthread_mutex_t,
};
pub extern fn sqfs_cache_init(cache: [*c]sqfs_cache, size: usize, count: usize, dispose: sqfs_cache_dispose) sqfs_err;
pub extern fn sqfs_cache_destroy(cache: [*c]sqfs_cache) void;
pub extern fn sqfs_cache_get(cache: [*c]sqfs_cache, idx: sqfs_cache_idx) ?*anyopaque;
pub extern fn sqfs_cache_add(cache: [*c]sqfs_cache, idx: sqfs_cache_idx) ?*anyopaque;
pub const sqfs_block_cache_entry = extern struct {
    block: [*c]sqfs_block,
    data_size: usize,
};
pub extern fn sqfs_block_cache_init(cache: [*c]sqfs_cache, count: usize) sqfs_err;
pub extern fn sqfs_frag_entry(fs: [*c]sqfs, frag: [*c]struct_squashfs_fragment_entry, idx: u32) sqfs_err;
pub extern fn sqfs_frag_block(fs: [*c]sqfs, inode: [*c]sqfs_inode, offset: [*c]usize, size: [*c]usize, block: [*c][*c]sqfs_block) sqfs_err;
pub const sqfs_blocklist_entry = u32;
pub const sqfs_blocklist = extern struct {
    fs: [*c]sqfs,
    remain: usize,
    cur: sqfs_md_cursor,
    started: c_short,
    pos: u64,
    block: u64,
    header: sqfs_blocklist_entry,
    input_size: u32,
};
pub extern fn sqfs_blocklist_count(fs: [*c]sqfs, inode: [*c]sqfs_inode) usize;
pub extern fn sqfs_blocklist_init(fs: [*c]sqfs, inode: [*c]sqfs_inode, bl: [*c]sqfs_blocklist) void;
pub extern fn sqfs_blocklist_next(bl: [*c]sqfs_blocklist) sqfs_err;
pub extern fn sqfs_read_range(fs: [*c]sqfs, inode: [*c]sqfs_inode, start: sqfs_off_t, size: [*c]sqfs_off_t, buf: ?*anyopaque) sqfs_err;
pub const sqfs_blockidx_entry = extern struct {
    data_block: u64,
    md_block: u32,
};
pub extern fn sqfs_blockidx_init(cache: [*c]sqfs_cache) sqfs_err;
pub extern fn sqfs_blockidx_blocklist(fs: [*c]sqfs, inode: [*c]sqfs_inode, bl: [*c]sqfs_blocklist, start: sqfs_off_t) sqfs_err;
pub const sqfs_compression_type = c_int;
pub extern fn sqfs_compression_name(@"type": sqfs_compression_type) [*c]u8;
pub extern fn sqfs_decompressor_get(@"type": sqfs_compression_type) sqfs_decompressor;
pub const sqfs_table = extern struct {
    each: usize,
    blocks: [*c]u64,
};
pub extern fn sqfs_table_init(table: [*c]sqfs_table, fd: sqfs_fd_t, start: sqfs_off_t, each: usize, count: usize) sqfs_err;
pub extern fn sqfs_table_destroy(table: [*c]sqfs_table) void;
pub extern fn sqfs_table_get(table: [*c]sqfs_table, fs: [*c]sqfs, idx: usize, buf: ?*anyopaque) sqfs_err;
pub extern fn sqfs_version_supported(min_major: [*c]c_int, min_minor: [*c]c_int, max_major: [*c]c_int, max_minor: [*c]c_int) void;
pub extern fn sqfs_divceil(total: u64, group: usize) usize;
pub extern fn sqfs_init(fs: [*c]sqfs, fd: sqfs_fd_t, offset: usize) sqfs_err;
pub extern fn sqfs_destroy(fs: [*c]sqfs) void;
pub extern fn sqfs_version(fs: [*c]sqfs, major: [*c]c_int, minor: [*c]c_int) void;
pub extern fn sqfs_compression(fs: [*c]sqfs) sqfs_compression_type;
pub extern fn sqfs_md_header(hdr: u16, compressed: [*c]c_short, size: [*c]u16) void;
pub extern fn sqfs_data_header(hdr: u32, compressed: [*c]c_short, size: [*c]u32) void;
pub extern fn sqfs_block_read(fs: [*c]sqfs, pos: sqfs_off_t, compressed: c_short, size: u32, outsize: usize, block: [*c][*c]sqfs_block) sqfs_err;
pub extern fn sqfs_block_dispose(block: [*c]sqfs_block) void;
pub extern fn sqfs_md_block_read(fs: [*c]sqfs, pos: sqfs_off_t, data_size: [*c]usize, block: [*c][*c]sqfs_block) sqfs_err;
pub extern fn sqfs_data_block_read(fs: [*c]sqfs, pos: sqfs_off_t, hdr: u32, block: [*c][*c]sqfs_block) sqfs_err;
pub extern fn sqfs_md_cache(fs: [*c]sqfs, pos: [*c]sqfs_off_t, block: [*c][*c]sqfs_block) sqfs_err;
pub extern fn sqfs_data_cache(fs: [*c]sqfs, cache: [*c]sqfs_cache, pos: sqfs_off_t, hdr: u32, block: [*c][*c]sqfs_block) sqfs_err;
pub extern fn sqfs_md_cursor_inode(cur: [*c]sqfs_md_cursor, id: sqfs_inode_id, base: sqfs_off_t) void;
pub extern fn sqfs_md_read(fs: [*c]sqfs, cur: [*c]sqfs_md_cursor, buf: ?*anyopaque, size: usize) sqfs_err;
pub extern fn sqfs_inode_get(fs: [*c]sqfs, inode: [*c]sqfs_inode, id: sqfs_inode_id) sqfs_err;
pub extern fn sqfs_mode(inode_type: c_int) sqfs_mode_t;
pub extern fn sqfs_id_get(fs: [*c]sqfs, idx: u16, id: [*c]sqfs_id_t) sqfs_err;
pub extern fn sqfs_readlink(fs: [*c]sqfs, inode: [*c]sqfs_inode, buf: [*c]u8, size: [*c]usize) sqfs_err;
pub extern fn sqfs_export_ok(fs: [*c]sqfs) c_int;
pub extern fn sqfs_export_inode(fs: [*c]sqfs, n: sqfs_inode_num, i: [*c]sqfs_inode_id) sqfs_err;
pub extern fn sqfs_inode_root(fs: [*c]sqfs) sqfs_inode_id;
pub const sqfs_stack_free_t = ?*const fn (?*anyopaque) callconv(.C) void;
pub const sqfs_stack = extern struct {
    value_size: usize,
    size: usize,
    capacity: usize,
    items: [*c]u8,
    freer: sqfs_stack_free_t,
};
pub extern fn sqfs_stack_init(s: [*c]sqfs_stack) void;
pub extern fn sqfs_stack_create(s: [*c]sqfs_stack, vsize: usize, initial: usize, freer: sqfs_stack_free_t) sqfs_err;
pub extern fn sqfs_stack_destroy(s: [*c]sqfs_stack) void;
pub extern fn sqfs_stack_push(s: [*c]sqfs_stack, vout: ?*anyopaque) sqfs_err;
pub extern fn sqfs_stack_pop(s: [*c]sqfs_stack) c_short;
pub extern fn sqfs_stack_size(s: [*c]sqfs_stack) usize;
pub extern fn sqfs_stack_at(s: [*c]sqfs_stack, i: usize, vout: ?*anyopaque) sqfs_err;
pub extern fn sqfs_stack_top(s: [*c]sqfs_stack, vout: ?*anyopaque) sqfs_err;
pub const sqfs_traverse = extern struct {
    dir_end: c_short,
    entry: sqfs_dir_entry,
    path: [*c]u8,
    state: c_int,
    fs: [*c]sqfs,
    namebuf: sqfs_name,
    ...
    path_size: usize,
    path_cap: usize,
    path_last_size: usize,
};
pub extern fn sqfs_traverse_open(trv: [*c]sqfs_traverse, fs: [*c]sqfs, iid: sqfs_inode_id) sqfs_err;
pub extern fn sqfs_traverse_open_inode(trv: [*c]sqfs_traverse, fs: [*c]sqfs, inode: [*c]sqfs_inode) sqfs_err;
pub extern fn sqfs_traverse_close(trv: [*c]sqfs_traverse) void;
pub extern fn sqfs_traverse_next(trv: [*c]sqfs_traverse, err: [*c]sqfs_err) c_short;
pub extern fn sqfs_traverse_prune(trv: [*c]sqfs_traverse) sqfs_err;
...
pub extern fn sqfs_fd_open(path: [*c]const u8, fd: [*c]sqfs_fd_t) sqfs_err;
pub extern fn sqfs_fd_close(fd: sqfs_fd_t) void;
pub extern fn sqfs_open_image(fs: [*c]sqfs, image: [*c]const u8, offset: usize) sqfs_err;
pub extern fn sqfs_stat(fs: [*c]sqfs, inode: [*c]sqfs_inode, st: [*c]struct_stat) sqfs_err;
pub const struct_squash_file = extern struct {
    fd: c_int,
    fs: [*c]sqfs,
    node: sqfs_inode,
    st: struct_stat,
...
pub const struct_squash_fdtable = extern struct {
    nr: usize,
    fds: [*c][*c]struct_squash_file,
    end: usize,
};
pub extern var squash_global_fdtable: struct_squash_fdtable;
const struct_unnamed_25 = extern struct {
    entry: sqfs_dir_entry,
    sysentry: struct_dirent,
    name: sqfs_name,
    not_eof: c_short,
};
pub const SQUASH_DIR = extern struct {
    fs: [*c]sqfs,
    fd: c_int,
    node: sqfs_inode,
    dir: sqfs_dir,
    entries: [*c]struct_unnamed_25,
    nr: usize,
    actual_nr: c_int,
    loc: c_long,
    filename: [*c]u8,
...
pub extern var squash_errno: sqfs_err;
pub extern fn squash_start(...) sqfs_err;
pub extern fn squash_readlink_inode(fs: [*c]sqfs, node: [*c]sqfs_inode, buf: [*c]u8, bufsize: usize) isize;
pub extern fn squash_follow_link(fs: [*c]sqfs, path: [*c]const u8, node: [*c]sqfs_inode) sqfs_err;
pub extern fn squash_find_entry(ptr: ?*anyopaque) [*c]struct_squash_file;
pub extern fn squash_stat(fs: [*c]sqfs, path: [*c]const u8, buf: [*c]struct_stat) c_int;
pub extern fn squash_lstat(fs: [*c]sqfs, path: [*c]const u8, buf: [*c]struct_stat) c_int;
pub extern fn squash_fstat(vfd: c_int, buf: [*c]struct_stat) c_int;
pub extern fn squash_open(fs: [*c]sqfs, path: [*c]const u8) c_int;
pub extern fn squash_open_inner(fs: [*c]sqfs, path: [*c]const u8, follow_link: c_short) c_int;
pub extern fn squash_close(vfd: c_int) c_int;
pub extern fn squash_read(vfd: c_int, buf: ?*anyopaque, nbyte: sqfs_off_t) isize;
pub extern fn squash_lseek(vfd: c_int, offset: off_t, whence: c_int) off_t;
pub extern fn squash_readlink(fs: [*c]sqfs, path: [*c]const u8, buf: [*c]u8, bufsize: usize) isize;
pub extern fn squash_opendir(fs: [*c]sqfs, filename: [*c]const u8) [*c]SQUASH_DIR;
pub extern fn squash_opendir_inner(fs: [*c]sqfs, filename: [*c]const u8, follow_link: c_short) [*c]SQUASH_DIR;
pub extern fn squash_closedir(dirp: [*c]SQUASH_DIR) c_int;
pub extern fn squash_readdir(dirp: [*c]SQUASH_DIR) [*c]struct_dirent;
pub extern fn squash_telldir(dirp: [*c]SQUASH_DIR) c_long;
pub extern fn squash_seekdir(dirp: [*c]SQUASH_DIR, loc: c_long) void;
pub extern fn squash_rewinddir(dirp: [*c]SQUASH_DIR) void;
pub extern fn squash_dirfd(dirp: [*c]SQUASH_DIR) c_int;
pub extern fn squash_scandir(fs: [*c]sqfs, dirname: [*c]const u8, namelist: [*c][*c][*c]struct_dirent, select: ?*const fn ([*c]const struct_dirent) callconv(.C) c_int, compar: ?*const fn ([*c][*c]const struct_dirent, [*c][*c]const struct_dirent) callconv(.C) c_int) c_int;
pub extern fn squash_tmpdir(...) [*c]const u8;
pub extern fn squash_tmpf(tmpdir: [*c]const u8, ext_name: [*c]const u8) [*c]const u8;
pub extern fn squash_extract(fs: [*c]sqfs, path: [*c]const u8, ext_name: [*c]const u8) [*c]const u8;
pub extern fn squash_extract_clear_cache(...) void;
...
pub const SQUASHFS_CACHED_FRAGMENTS = @compileError("unable to translate macro: undefined identifier `CONFIG_SQUASHFS_FRAGMENT_CACHE_SIZE`"); // vendor/libsquash/include/squash/squashfs_fs.h:43:9
...
pub const SQUASH_OS_PATH = @compileError("unable to translate C expr: unexpected token 'const'"); // vendor/libsquash/include/squash.h:237:9
...
pub const SQFS_DIR_H = "";
pub const SQFS_COMMON_H = "";
...
pub const MUTEX = pthread_mutex_t;
pub const _SYS_DIR_H = @as(c_int, 1);
...
pub const SQUASH_DIRENT = dirent;
pub const SQFS_INODE_ID_BYTES = @as(c_int, 6);
pub const SQUASHFS_FS = "";
...
pub const SQUASHFS_MAGIC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x73717368, .hexadecimal);
pub const SQUASHFS_MAJOR = @as(c_int, 4);
pub const SQUASHFS_MINOR = @as(c_int, 0);
pub const SQUASHFS_START = @as(c_int, 0);
pub const SQUASHFS_METADATA_SIZE = @as(c_int, 8192);
pub const SQUASHFS_METADATA_LOG = @as(c_int, 13);
pub const SQUASHFS_FILE_SIZE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 131072, .decimal);
pub const SQUASHFS_FILE_LOG = @as(c_int, 17);
pub const SQUASHFS_FILE_MAX_SIZE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 1048576, .decimal);
pub const SQUASHFS_FILE_MAX_LOG = @as(c_int, 20);
pub const SQUASHFS_IDS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 65536, .decimal);
pub const SQUASHFS_NAME_LEN = @as(c_int, 256);
pub const SQUASHFS_PATH_LEN = @as(c_int, 2048);
pub const SQUASHFS_MAX_LINK_LEVEL = @as(c_int, 32);
pub const SQUASHFS_INVALID_FRAG = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0xffffffff, .hexadecimal);
pub const SQUASHFS_INVALID_XATTR = @import("std").zig.c_translation.promoteIntLiteral(c_uint, 0xffffffff, .hexadecimal);
pub const SQUASHFS_INVALID_BLK = @import("std").zig.c_translation.cast(i64, -@as(c_int, 1));
pub const SQUASHFS_NOI = @as(c_int, 0);
pub const SQUASHFS_NOD = @as(c_int, 1);
pub const SQUASHFS_NOF = @as(c_int, 3);
pub const SQUASHFS_NO_FRAG = @as(c_int, 4);
pub const SQUASHFS_ALWAYS_FRAG = @as(c_int, 5);
pub const SQUASHFS_DUPLICATE = @as(c_int, 6);
pub const SQUASHFS_EXPORT = @as(c_int, 7);
pub const SQUASHFS_COMP_OPT = @as(c_int, 10);
pub const SQUASHFS_DIR_TYPE = @as(c_int, 1);
pub const SQUASHFS_REG_TYPE = @as(c_int, 2);
pub const SQUASHFS_SYMLINK_TYPE = @as(c_int, 3);
pub const SQUASHFS_BLKDEV_TYPE = @as(c_int, 4);
pub const SQUASHFS_CHRDEV_TYPE = @as(c_int, 5);
pub const SQUASHFS_FIFO_TYPE = @as(c_int, 6);
pub const SQUASHFS_SOCKET_TYPE = @as(c_int, 7);
pub const SQUASHFS_LDIR_TYPE = @as(c_int, 8);
pub const SQUASHFS_LREG_TYPE = @as(c_int, 9);
pub const SQUASHFS_LSYMLINK_TYPE = @as(c_int, 10);
pub const SQUASHFS_LBLKDEV_TYPE = @as(c_int, 11);
pub const SQUASHFS_LCHRDEV_TYPE = @as(c_int, 12);
pub const SQUASHFS_LFIFO_TYPE = @as(c_int, 13);
pub const SQUASHFS_LSOCKET_TYPE = @as(c_int, 14);
pub const SQUASHFS_XATTR_USER = @as(c_int, 0);
pub const SQUASHFS_XATTR_TRUSTED = @as(c_int, 1);
pub const SQUASHFS_XATTR_SECURITY = @as(c_int, 2);
pub const SQUASHFS_XATTR_VALUE_OOL = @as(c_int, 256);
pub const SQUASHFS_XATTR_PREFIX_MASK = @as(c_int, 0xff);
pub const SQUASHFS_COMPRESSED_BIT = @as(c_int, 1) << @as(c_int, 15);
pub const SQUASHFS_COMPRESSED_BIT_BLOCK = @as(c_int, 1) << @as(c_int, 24);
pub const SQUASHFS_CACHED_BLKS = @as(c_int, 8);
pub const SQUASHFS_MAX_FILE_SIZE_LOG = @as(c_int, 64);
pub const SQUASHFS_MAX_FILE_SIZE = @as(c_longlong, 1) << (SQUASHFS_MAX_FILE_SIZE_LOG - @as(c_int, 2));
pub const SQUASHFS_META_INDEXES = @import("std").zig.c_translation.MacroArithmetic.div(SQUASHFS_METADATA_SIZE, @import("std").zig.c_translation.sizeof(c_uint));
pub const SQUASHFS_META_ENTRIES = @as(c_int, 127);
pub const SQUASHFS_META_SLOTS = @as(c_int, 8);
pub const ZLIB_COMPRESSION = @as(c_int, 1);
pub const SQFS_FILE_H = "";
pub const SQFS_CACHE_H = "";
pub const SQFS_CACHE_IDX_INVALID = @as(c_int, 0);
pub const SQFS_FS_H = "";
pub const SQFS_DECOMPRESS_H = "";
pub const SQFS_COMP_UNKNOWN = @as(c_int, 0);
pub const SQFS_COMP_MAX = @as(c_int, 16);
pub const SQFS_TABLE_H = "";
pub const SQFS_TRAVERSE_H = "";
pub const SQFS_STACK_H = "";
pub const SQFS_UTIL_H = "";
...
pub const SQFS_PRIVATE_H = "";
pub const FDTABLE_H_60F13289 = "";
pub const DIRENT_H_245C4278 = "";
pub const SQUASH_DIR_MAGIC_LEN = @as(c_int, 18);
pub const MAX_DIR_ENT = @as(c_int, 1024);
pub const SQUASH_SEEK_SET = @as(c_int, 0);
pub const SQUASH_SEEK_CUR = @as(c_int, 1);
pub const SQUASH_SEEK_END = @as(c_int, 2);
pub inline fn SQUASH_VALID_VFD(vfd: anytype) @TypeOf((vfd < squash_global_fdtable.nr) and (NULL != squash_global_fdtable.fds[@intCast(usize, vfd)])) {
    return (vfd < squash_global_fdtable.nr) and (NULL != squash_global_fdtable.fds[@intCast(usize, vfd)]);
}
pub inline fn SQUASH_VFD_FILE(vfd: anytype) @TypeOf(squash_global_fdtable.fds[@intCast(usize, vfd)]) {
    return squash_global_fdtable.fds[@intCast(usize, vfd)];
}
...
pub const squashfs_super_block = struct_squashfs_super_block;
pub const squashfs_base_inode = struct_squashfs_base_inode;
pub const squashfs_dir_index = struct_squashfs_dir_index;
pub const squashfs_ipc_inode = struct_squashfs_ipc_inode;
pub const squashfs_lipc_inode = struct_squashfs_lipc_inode;
pub const squashfs_dev_inode = struct_squashfs_dev_inode;
pub const squashfs_ldev_inode = struct_squashfs_ldev_inode;
pub const squashfs_symlink_inode = struct_squashfs_symlink_inode;
pub const squashfs_reg_inode = struct_squashfs_reg_inode;
pub const squashfs_lreg_inode = struct_squashfs_lreg_inode;
pub const squashfs_dir_inode = struct_squashfs_dir_inode;
pub const squashfs_ldir_inode = struct_squashfs_ldir_inode;
pub const squashfs_dir_entry = struct_squashfs_dir_entry;
pub const squashfs_dir_header = struct_squashfs_dir_header;
pub const squashfs_fragment_entry = struct_squashfs_fragment_entry;
pub const squashfs_xattr_entry = struct_squashfs_xattr_entry;
pub const squashfs_xattr_val = struct_squashfs_xattr_val;
pub const squashfs_xattr_id = struct_squashfs_xattr_id;
pub const squashfs_xattr_id_table = struct_squashfs_xattr_id_table;
...
pub const squash_file = struct_squash_file;
pub const squash_fdtable = struct_squash_fdtable;
